...
def sample(ndim, nwalkers, w, ur, sigma_ur, nuvu, sigma_nuvu, age, pd, ps):
    ...
    pos = [[13.0, 1.25, 13.0, 1.25] + 1e-4*N.random.randn(ndim) for i in range(nwalkers)]
    ...
    samples_save = '/Users/becky/Projects/Green-Valley-Project/bayesian/find_t_tau/samples_discs_'+str(len(samples))+'_'+str(len(age))+'_'+str(time.strftime('%H_%M_%d_%m_%y'))+'.npy'
